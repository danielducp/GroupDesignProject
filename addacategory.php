...
$sqlQuery = $pdo->query('SELECT CategoryID FROM category ORDER BY CategoryID DESC LIMIT 1');
$row=$sqlQuery->fetch();
$staffnumber = $row['CategoryID']+1;
...
<html>
    ...
    <body>
        ...
        <form action="addasupplier.php" method="post">
            ...
            <input type="CategoryName" id="CategoryName" class="form-control" name="CategoryName"><br>
