...
<?php 
    ...
    $stmt = $pdo->prepare("SELECT * FROM `department`  LIMIT $offset, $numberofrecords "); 
$stmt->execute();
...
{    
    echo "<TD align=center>Department Name: ".$row['DepartmentName']."";

    echo "<br><align=center>Total Expenditure: ".$row['TotalExpenditure']."";
