...
<?php
    ...
    if(isset($_POST['register'])){        
        ...
        $sql = "INSERT INTO staff (staffid, stafftitle, staffname, staffrole, storeid, DepartmentID, password) VALUES (:staffid, :stafftitle, :staffname, :staffrole, :storeid, :DepartmentID, :password)";
        $stmt = $pdo->prepare($sql);
